...
var app = new Vue({
    ...
    methods: {
        ...
        async sendFile(e) {
            ...
            const result = await axios.post("/stream", form)
            socket.emit("image", {filename: result.data, type: this.file.type})
        },
        async getFile(e) {
            e.preventDefault()
    ...
    created() {
        ...
        socket.on('image', (payload) => {
            ...
            this.pauseImg(el[this.fileSrc.mediaType], this.fileSrc.mediaType)
